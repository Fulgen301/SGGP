...
private func Traveling()
{
  ...
  //Metall schweißen
  if(GetMaterial(0,0) == Material("Granite")) 
  {
   Message("Ich bin reich!", this());
   CreateObject(ROCK)->Explode(2);
  }
...
private func HitObject(object pObject) {
  ...
  if(BulletStrike(pObject)) {
    CastParticles("PxSpark",5,20,0,10,30,40, RGB(187, 214, 224), RGB(200, 224, 250));
    Remove();
  }
}
